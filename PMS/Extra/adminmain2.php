...
$result5 = mysql_query($sql5);
 if(!($row5 = mysql_fetch_array($result5))){echo"<h2 style='margin-left:10px;'>List of Projects</h2><br><br><center>No projects entered</center>";}
	else{echo"<center><div class='col-md-6' style='margin-left:10px;'>
          <h2 style='margin-left:10px;'>List of Projects</h2><table class='table table-bordered'>
            <thead>
              <tr>
                <th>#</th>
                <th>Title</th>
...
echo "	<form method='post' action='tt_connection.php' class='form-horizontal' style='margin-left:40px; width:300px;border:2px;' >";
